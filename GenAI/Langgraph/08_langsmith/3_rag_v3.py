...
# LANGSMITH_PROJECT="Langchain-Demo-03-Rag-Chatbot-01"
...
@traceable(name="split_documents", tags=['text', 'splitting'], metadata={'text-splitting': 'RecursiveCharacterTextSplitting'})
